...
void Usage() {
    std::cout
        ...
        << "  live-view-handoff --alias CAM-A --count 1..5 [--frames 1] [--wpd-command-target functional|omit]\n"
        << "    --exclusive-camera-control-confirmed --dedicated-spool-scope-confirmed --exact-object-delete-confirmed\n"
        << "  hybrid-capture-single --alias CAM-A --count 1..5 --exclusive-camera-control-confirmed\n"
        ...
        << "  hybrid-capture-pair --count 1..5 --exclusive-camera-control-confirmed\n"
