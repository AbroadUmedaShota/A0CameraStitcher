...
- 監査基準commit: `d4bc288092e0ab7c40d3d280baad8050e6db150a`
...
3. SDK unloadを越えて同じD810を安全に選べる、文書化済みの恒久identity／SDK-WPD correlationを確立する。現行の厳格条件を維持できるが、現時点では利用可能な方式がない。

推奨は3。少なくとも1の例外を製品責任者がADRとして承認するまでは、one-shotを含む実シャッター操作を行わない。
